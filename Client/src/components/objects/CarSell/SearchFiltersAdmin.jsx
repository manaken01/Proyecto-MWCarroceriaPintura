...
/**
 * Display of searchbar and filters for admin, which includes an add car button
 * @param {*}
        ...
        <div className="container" style={{ marginBottom: '4%', backgroundColor: "#F9F9F9", boxShadow: "#E3E3E3 3px 3px 3px" }}>
            ...
            <div className="row mt-3 mb-3" style={{ paddingBottom: '2%' }}>
                ...
                <div className="col d-flex justify-content-end">
                    <button className="btn btn-outline-secondary" onClick={handleShowRepuestoModal} style={{ backgroundColor: '#C80B16', borderColor: '#C80B16', color: 'white' }} >Agregar nuevo carro</button>
                </div>
                <Modal show={showRepuestoModal} onHide={handleClose} style={{ backgroundColor: 'transparent' }}>
                    <Modal.Header closeButton style={{ backgroundColor: '#F9F9F9' }}>
                    </Modal.Header>
                    <Modal.Body style={{ backgroundColor: '#F9F9F9' }}>
                        <CarSellForm refreshParent={handleResults} closeForm = {handleClose}/>
                    </Modal.Body>
