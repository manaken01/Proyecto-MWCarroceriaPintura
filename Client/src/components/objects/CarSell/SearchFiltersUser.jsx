...
/**
 * Display of searchbar and filters for general users
 * @param {*}
...
const SearchFiltersUser = ({dropdowns, setSelectedItems, handleResults,setSearch, search}) => {
...
export default SearchFiltersUser;