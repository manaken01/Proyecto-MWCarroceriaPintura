            ...
            <div className='row'>{
                cards.map(card => (
                    <div className='col-md-6' key={card.id}>
                        <Card name={card.name} car={card.car} price={card.price} category={card.category} stock={card.stock} brand= {card.brand} bodyshape={card.bodyshape} version={card.version} gen={card.gen} pic={card.pic} />
                    </div>
                ))
            }
            </div>
